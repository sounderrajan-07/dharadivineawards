...
git commit -m "Add dedicated Home Page Images workspace with Cloudinary upload support, remove Show on Home Page checkbox from Gallery, and add video file upload with live preview for Hero section"
