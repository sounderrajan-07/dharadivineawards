...
export type TabType = 'overview' | 'home-page-images' | 'upi-validation' | 'nominations' | 'donations' | 'delegates' | 'volunteers' | 'enquiries' | 'youtube-highlights' | 'gallery' | 'events' | 'event-config' | 'subdomains' | 'settings';
